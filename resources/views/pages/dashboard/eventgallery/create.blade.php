<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Product &raquo; {{$event->name}} &raquo; Gallery &raquo; Uppload Photos
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form action="{{route('dashboard.event.eventgallery.store', $event->id)}}" method="post" class="w-full" enctype="multipart/form-data">
                    @csrf
