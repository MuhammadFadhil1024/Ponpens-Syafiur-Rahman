...
@section('content')
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ url('frontend/folio/assets2/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  ...
  <link href="{{ url('frontend/folio/assets/css/style2
  .css') }}" rel="stylesheet">
                        ...
                        <ul class="entry-comments-list list-unstyled">
                          <li>
                            <div class="entry-comments-item">
                              <img src="{{ url('frontend/folio/assets/img/avatar.jpg') }}" class="entry-comments-avatar" alt="">
