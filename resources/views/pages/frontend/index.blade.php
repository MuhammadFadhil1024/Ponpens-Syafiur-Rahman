...
<section class="flexslider">
    <ul class="slides">
      <li style="background-image: url({{ url('frontend/enlight-master/img/slider_1.jpg') }})" class="overlay">
        <div class="container">
          <div class="row">
      ...
      <li style="background-image: url({{ url('frontend/enlight-master//slider_2.jpg') }})" class="overlay">
        <div class="container">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="probootstrap-slider-text text-center">
      ...
      <li style="background-image: url({{ url('frontend/enlight-master/img/slider_3.jpg') }})" class="overlay">
        <div class="container">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="probootstrap-slider-text text-center">
