...
@section('content')
    ...
    <section class="flexslider">
        ...
        <li style="background-image: url(frontend/img/slider_3.jpg)" class="overlay">
            <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                <div class="probootstrap-slider-text text-center">
    ...
    <section class="probootstrap-section">
        ...
        <div class="row">
            ...
            <div class="probootstrap-flex-block">
                ...
                <div class="probootstrap-image probootstrap-animate" style="background-image: url(frontend/img/slider_3.jpg)">
    ...
    <section class="probootstrap-section probootstrap-section-colored probootstrap-bg probootstrap-custom-heading probootstrap-tab-section" style="background-image: url(frontend/img/slider_2.jpg)">
        <div class="container">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="owl-carousel" id="owl1">
                        ...
                        <a href="#" class="probootstrap-featured-news-box">
                            <figure class="probootstrap-media"><img src="/frontend/img/img_sm_3.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive"></figure>
                            <div class="probootstrap-text">
                        ...
                        <div class="item">
                        <a href="#" class="probootstrap-featured-news-box">
                            <figure class="probootstrap-media"><img src="/frontend/img/img_sm_1.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive"></figure>
                            <div class="probootstrap-text">
                            <h3>Tempora consectetur unde nisi</h3>
                        ...
                        <div class="item">
                        <a href="#" class="probootstrap-featured-news-box">
                            <figure class="probootstrap-media"><img src="/frontend/img/img_sm_2.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive"></figure>
                            <div class="probootstrap-text">
                            <h3>Tempora consectetur unde nisi</h3>
    ...
    <section class="probootstrap-section probootstrap-bg-white probootstrap-border-top">
        ...
        <div class="row">
            ...
            <div class="probootstrap-service-2 probootstrap-animate">
                <div class="image">
                <div class="image-bg">
                    <img src="frontend/img/img_sm_1.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                </div>
                </div>
                <div class="text">
            ...
            <div class="probootstrap-service-2 probootstrap-animate">
                <div class="image">
                <div class="image-bg">
                    <img src="/frontend/img/img_sm_3.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                </div>
                </div>
                <div class="text">
                <span class="probootstrap-meta"><i class="icon-calendar2"></i> July 10, 2017</span>
            ...
            <div class="probootstrap-service-2 probootstrap-animate">
                <div class="image">
                <div class="image-bg">
                    <img src="/frontend/img/img_sm_2.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                </div>
                </div>
                <div class="text">
                <span class="probootstrap-meta"><i class="icon-calendar2"></i> July 10, 2017</span>
            ...
            <div class="probootstrap-service-2 probootstrap-animate">
                <div class="image">
                <div class="image-bg">
                    <img src="/frontend/img/img_sm_4.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                </div>
                </div>
                <div class="text">
                <span class="probootstrap-meta"><i class="icon-calendar2"></i> July 10, 2017</span>
    ...
    <section class="probootstrap-section">
        ...
        <div class="row">
            ...
            <div class="probootstrap-teacher text-center probootstrap-animate">
                <figure class="media">
                <img src="/frontend/img/person_1.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                </figure>
                <div class="text">
                <h3>Chris Worth</h3>
            ...
            <div class="probootstrap-teacher text-center probootstrap-animate">
                <figure class="media">
                <img src="/frontend/img/person_5.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                </figure>
                <div class="text">
                <h3>Janet Morris</h3>
                <p>English Teacher</p>
            ...
            <div class="probootstrap-teacher text-center probootstrap-animate">
                <figure class="media">
                <img src="/frontend/img/person_6.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                </figure>
                <div class="text">
                <h3>Linda Reyez</h3>
                <p>Math Teacher</p>
            ...
            <div class="probootstrap-teacher text-center probootstrap-animate">
                <figure class="media">
                <img src="/frontend/img/person_7.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                </figure>
                <div class="text">
                <h3>Jessa Sy</h3>
                <p>Physics Teacher</p>
    ...
    <section class="probootstrap-section probootstrap-bg probootstrap-section-colored probootstrap-testimonial" style="background-image: url(frontend/img/slider_4.jpg);">
        <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center section-heading probootstrap-animate">
        ...
        <div class="row">
            ...
            <div class="owl-carousel owl-carousel-testimony owl-carousel-fullwidth">
                ...
                <div class="probootstrap-testimony-wrap text-center">
                    <figure>
                    <img src="/frontend/img/person_1.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                    </figure>
                ...
                <div class="probootstrap-testimony-wrap text-center">
                    <figure>
                    <img src="/frontend/img/person_2.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                    </figure>
                ...
                <div class="probootstrap-testimony-wrap text-center">
                    <figure>
                    <img src="/frontend/img/person_3.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                    </figure>
